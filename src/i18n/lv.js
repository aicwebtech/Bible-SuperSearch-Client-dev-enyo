module.exports = {
    ...
    // Search Forms
    'Select Bible version(s)': 'Izvēlieties Bībeles versiju(-as)',
    'Search': 'Meklēt',
    'Search the Bible': 'Meklēt Bībelē',
    'Go': 'Atvērt',
    ...
    'Cross References': 'Savstarpējās atsauces',
    'Hidden': 'Paslēpts',
    'Toggle': 'Pārslēgt',
    'Show': 'Rādīt',
    ...
    'Entire Bible': 'Visa Bībele',
    'Passage(s) listed below': 'Zemāk attēlotās rakstvietas',
    'Passage(s) listed above': 'Augstāk attēlotās rakstvietas',
    ...
    'Enter word(s), phrase(s) or expression(s)' : 'Ievadiet vārdu(-us), frāzi(-es) vai izteicienu(-us)', 
    'Example': 'Piemērs',

    'Search for' : 'Meklēšanas nosacījums',
    'Match': 'Sakrīt',
    'All Words': 'Visi Vārdi',
    'Any Word': 'Jebkurš Vārds',
    'Exact Phrase': 'Precīza Frāze',
    'Only One Word': 'Tikai Viens Vārds',
    'Two or More Words': 'Divi vai Vairāk Vārdi',
    'Words Within 5 Verses': 'Vārdi, kas Atrodami 5 Pantu Diapazonā',
    'Words Within Same Chapter': 'Vārdi, kas Atrodami Vienas Nodaļas Ietvaros',
    'Words Within Same Book': 'Vārdi, kas Atrodami Vienas Grāmatas Ietvaros',
    'Boolean Expression': 'Meklēšana, Izmantojot Būla Operatorus (Boolean Expression)',
    'Regular Expression': 'Meklēšana, Izmantojot Regulāro Izteiksmju Sintaksi (Regular Expression)',
    'Select one ...' : 'Izvēlieties vienu ...',

    'Enter search keyword(s) or passage reference(s)': 'Ievadiet meklējamo atslēgas vārdu(-us) vai rakstvietas(-tu) atsauci(-es)',
    'Tip: Entering both a passage and a search query will result in the limitation of the search to the specified passage(s).': 'Ieteikums: Ievadot gan rakstvietu(-as), gan meklējamo(-os) atslēgas vārdu(-us), meklēšana tiks veikta tikai norādītās(-o) rakstvietas(-tu) ietvaros.',
    
    // Advanced Search
    'Boolean Search': 'Būla meklēšana (Boolean Search)',
    'Passage Retrieval': 'Atvērt Rakstvietu(-as)',
    'Find words within': 'Atrast atslēgas vārdus apgabalā',
    'Proximity Search': 'Meklēšana atkarībā no atslēgas vārdu atrašanās attāluma tekstā (Proximity Search)',
    'Power Search': 'Padziļināta meklēšana',

    // <b> ... </b> is HTML for bold text, please ensure that your translation maintains the bold
    '<b>All</b> of the words' : '<b>Visi</b> no vārdiem',
    '<b>Any</b> of the words' : '<b>Jebkurš</b> no vārdiem',
    '<b>Only one</b> of the words': '<b>Tikai viens</b> no vārdiem',
    '<b>None</b> of the words' : '<b>Neviens</b> no vārdiem',
    'The <b>exact phrase</b>': '<b>Precīza frāze</b>',

    'Bible #': 'Bībele #', // downloads
    ...
    'Select None': 'Atlasīt Nevienu', // 5.0
    'Select': 'Atlasīt', // 5.0
    'Unselect': 'Noņemt Atlasi', // 5.0
    
    // Copy format options
    'Copy Format': 'Kopēšanas Formāts', // 5.0
    'Word Processor': 'Formatēts Teksts', // 5.0
    'Outline' : 'Strukturēts Teksts', // 5.0
    'Custom': 'Pielāgot', // 5.0

    'Single Verses': 'Ja Attēloti Atsevišķi Rakstvietu Panti, kas Satur Meklējamo Atslēgas Vārdu', // 
    'Reference - Text': 'Atsauce - Teksts', // 5.0
    'Text - Reference': 'Teksts - Atsauce', // 5.0
    'Text Only': 'Tikai Teksts', // 5.0
    'Separate Line': 'Atsevišķā Rindā', // 5.0

    'Multi-verse Passages': 'Ja Atvērta Rekastvieta ar Vairākiem Pantiem', // 5.0
    'Reference - Passage': 'Atsauce - Rakstvieta', // 5.0
    'Passage - Reference': 'Rakstvieta - Atsauce', // 5.0
    'Passage Only': 'Tikai Rakstvieta', // 5.0
    ...
    // Audio Bible
    'Listen': 'Klausīties', // 6.2
    'Audio Bible may have been generated by using AI, and not an actual human voice.': 'Audio Bībele var būt ģenerēta, izmantojot mākslīgo intelektu, nevis īstu cilvēka balsi.', // 6.2
    'Audio not available for this passage.': 'Šai rakstvietai audio nav pieejams.', // 6.2
    
    // Result and error messages
    
    // Your search produced (number of verses) results
    'Your search produced' : 'Veicot meklēšanu ir atrasti',  
    // (total number of verses)
    'results' : 'rezultāti',
    
    // Showing results [1] to [30]
    'Showing Results': 'Tiek attēloti meklēšanas rezultāti no',
    'to' : 'līdz',
    
    // Your search produced no results in [name of Bible version]
    'Your search produced no results in': 'Veicot meklēšanu netika atrasti rezultāti Bībelē:', 
    'However, verses from this Bible have been included for comparison.': 'Tomēr salīdzinājumam ir iekļauti un parādīti arī panti no šīs Bībeles.',
    
    // Operators such as [boolean operator] cannot be at the (beginning|end) of your search
    'Operators such as': 'Būla operators (Boolean operator)',
    'cannot be at the beginning of your search.': 'nevar atrasties pirms meklējamā atslēgas vārda',
    'cannot be at the end of your search.': 'nevar atrasties aiz meklējamā atslēgas vārda',
    'Please remove it, or use it\'s lower case equivalent.': 'Lūdzu, noņemiet to vai izmantojiet mazo burtu ekvivalentu.',

    // Your search for [attempted keywords] is invalid...
    'Your search for': 'Veicot meklēšanu ar jūsu ievadīto atslēgas vārdu',
    'is invalid, and appears to be a passage reference.': 'rezultāti netika atrasti, un izskatās, ka jūsu atslēgas vārds ir atsauce uz rakstvietu. Lai atvērtu rakstvietu(-as), lūdzu izmantot tam paredzēto ievades lauku.',
    'is invalid.': 'rezultāti netika atrasti.',

    // Your search was limited to [number of] verses
    'Your search was limited to': 'Jūsu meklēšanas rezultātu attēlotais skaits tika ierobežots. Tiek attēloti',
    'Please refine your search if necessary': 'Ja nepieciešams, lūdzu precizējiet meklējamo atslēgas vārdu un veiciet atkārtotu meklēšanu',

    'This Bible is in the Public Domain.': ' Šī Bībele ir publiski brīvi pieejama (Public Domain).',
    'This Bible is provided for research purposes only.': 'Šī Bībele ir paredzēta tikai pētniecības nolūkiem.',
    'An unknown error has occurred.' : ' Radās nezināma kļūda.',
    'An error has occurred, please try again later.': 'Ir radusies kļūda. Lūdzu, vēlāk mēģiniet vēlreiz.',
    'Error' : 'Kļūda',
    'Success': 'Izdevās',
    'Cache not found': 'Kešatmiņa nav atrasta',
    ...
    'Book not found': 'Grāmata nav atrasta',
    'Your parentheses are mismatched.': 'Jūsu iekavas ir neatbilstoši ievadītas.',
    'Your parentheses are mismatched, or you have a proximity operator inside of parentheses.': 'Jūsu iekavas ir neatbilstoši ievadītas, vai iekavās ir ievadīts atslēgas vārdu attāluma atrašanās meklēšanas operators (Proximity Search)',
    'Proximity operators such as PROX and CHAP can only be used with boolean searches' : ' Atslēgas vārdu attāluma atrašanās meklēšanas operatorus (Proximity Search), piemēram, PROX un CHAP, var izmantot tikai īstenojot Būla meklēšanu (Boolean Search)',
    'Note: PROX / CHAP operators cannot be enclosed within parentheses or brackets': 'Piezīme: PROX un CHAP operatori nevar atrasties parastajās iekavās vai kvadrātiekavās',
    'Your access to this API has been revoked.  Please contact system administrator.': 'Jūsu piekļuve šai API ir atspējota. Lūdzu, sazinieties ar sistēmas administratoru.',
    ...
    'Bereaved': 'Bēdās',
    'Bitter or Critical': 'Netiesāt citus',
    'Conscious of Sin': 'Apzinoties grēku',
    'Defeated': 'Piedzīvojot sakāvi',
    'Depressed': 'Nomāktībā un depresijā', 
    'Disaster Threatens': 'Briesmās un apdraudējumā',
    'Discouraged': 'Kad trūkst drosmes',
    'Doubting': 'Šaubu brīžos',
    'Facing a Crisis': 'Krīzes brīžos',
    'Faith Fails': 'Cīnoties ar ticības trūkumu',
    'Friends Fail': 'Kad pieviļ draugi', 
    'Hopeless': 'Bezcerībā',
    'Leaving Home': 'Aizceļojot, atrodoties svešumā',
    'Lonely': 'Vientulībā',
    'Needing God\'s protection': 'Meklējot Dieva palīdzību',
    'Needing Guidance': 'Meklējot Dieva vadību',
    'Needing Peace': 'Meklējot mieru',
    'Needing Rules for Living': 'Meklējot dzīvei pamatprincipus', 
    'Overcome': 'Pārvarot grūtības',
    'Prayerful': 'Kad nepieciešams lūgt Dievu',
    'Protected': 'Meklējot Dieva aizsardzību',
    'Sick or in Pain': 'Slimībā un sāpēs',
    'Sorrowful': 'Skumjās',
    'Tempted': 'Kārdinājumos', 
    'Thankful': 'Kad jūtaties pateicīgi',
    'Traveling': 'Ceļojumos un meklējumos',
    'Trouble, In': 'Ciešanās',
    'Troubled': 'Nospiestības brīžos',
    'Weary': 'Paguruma brīdī',
    'Worried': 'Raizēs un uztraukumā',
    ...
    'Birth of Christ / Life of Christ': 'Jēzus Kristus Dzimšana un Dzīve',
    'Imperfection in Churches and Believers': 'Baznīcu un Ticīgo Nepilnīgums',
    'Early human history, especially that of Israel': 'Agrīnā Cilvēces un Israēla Vēsture',
    'The relationship between the Old Testament Law and the Church': 'Saistība Bībeles Vecās Derības Likumiem (Bauslībai) ar Dieva Draudzi Jaunajā Derībā',
    'History and Law': 'Dieva doto Likumu (Bauslības) Vēsture',
    ...
    'Your download should begin shortly': 'Tūlīt tiks uzsākta lejupielāde',
    'If not, please click on the below link': 'Ja lejupielāde netiek uzsākta, lūdzu, noklikšķiniet uz zemāk esošās saites',
    'Manual Download': 'Manuāla Lejupielāde',
    'Please select at least one Bible': 'Lūdzu, izvēlieties vismaz vienu Bībeli',
    'Please select a format': 'Lūdzu, izvēlieties formātu',
    'Are you sure you want to exit?  This will end the current download.': 'Vai tiešām vēlaties iziet? Tā rezultātā tiks pārtraukta pašreizējā lejupielāde.',
    'Plain Text' : 'Vienkāršs Teksts',
    'Machine-readable Plain Text' : 'Mašīnlasāms Vienkāršs Teksts',
    'Spreadsheet' : 'Izklājlapa (Spreadsheet)',
    'Databases': 'Datu Bāzes',

    'PDF - Compact Text, Letter, Words of Christ in Red': 'PDF fails - Kompakts (Compact) teksts, Lapas izmērs Vēstules (Letter), Jēzus Kristus vārdi iekrāsoti sarkanā krāsā',
    'PDF - Compact Text, A4, Words of Christ in Red': 'PDF fails - Kompakts (Compact) teksts, Lapas izmērs A4, Jēzus Kristus vārdi iekrāsoti sarkanā krāsā',
    'PDF - Compact Text, Letter, Words of Christ Underlined': 'PDF fails - Kompakts (Compact) teksts, Lapas izmērs Vēstules (Letter), Jēzus Kristus vārdi pasvītroti',
    'PDF - Compact Text, A4, Words of Christ Underlined': 'PDF fails - Kompakts (Compact) teksts, Lapas izmērs A4, Jēzus Kristus vārdi pasvītroti',
    ...
    'Advanced Searches using Boolean': 'Izvērstā Meklēšana, izmantojot Būla (Boolean) operatoru(-us)',
    'Select' : 'Izvēlieties',
    'Operators': 'Operatori',
    'Operator': 'Operators',
    'Aliases': 'Izmantojamais Simbols',
    'Description': 'Apraksts',
    'Match both': 'Vienlaicīgi meklēt abus atslēgvārdus',
    'Match either': 'Meklēt vienu vai otru atslēgvārdu',
    'Match only one': 'Meklēt rakstvietas, kur ir sastopams tikai viens vai tikai otrs atslēgvārds',
    'Does not match': 'Meklēt rakstvietas, kur pirmais atslēgvārds ir sastopams tikai bez otra norādītā atslēgvārda',
    'Matches words in the same chapter': 'Meklēt tikai tās rakstvietas, kur ir sastopams viens vai abi atslēgvārdi, tikai tad, ja abi atslēgvārdi ir atrodami vienas nodaļas ietvaros',
    'Matches words in the same book': 'Meklēt tikai tās rakstvietas, kur ir sastopams viens vai abi atslēgvārdi, tikai tad, ja abi atslēgvārdi ir atrodami vienas grāmatas ietvaros',
    'Matches words in the same book, and within N verses of each other': 'Meklēt tikai tās rakstvietas, kur ir sastopams viens vai abi atslēgvārdi, tikai tad, ja abi atslēgvārdi ir atrodami vienas grāmatas ietvaros N secīgu pantu diapazonā',
    'Matches words in the same chapter, and within N verses of each other': 'Meklēt tikai tās rakstvietas, kur ir sastopams viens vai abi atslēgvārdi, tikai tad, ja abi atslēgvārdi ir atrodami vienas nodaļas ietvaros \'N\' secīgu pantu diapazonā', 
    ...
    'bibleBooks': [
        {
          "id": 1,
          "name": "Pirmā Mozus grāmata (Genesis)",
          "shortname": "1. Moz."
        },
        {
          "id": 2,
          "name": "Otrā Mozus grāmata (Exodus)",
          "shortname": "2. Moz."
        },
        {
          "id": 3,
          "name": "Trešā Mozus grāmata (Leviticus)",
          "shortname": "3. Moz."
        },
        {
          "id": 4,
          "name": "Ceturtā Mozus grāmata (Numeri)",
          "shortname": "4. Moz."
        },
        {
          "id": 5,
          "name": "Piektā Mozus grāmata (Deuteronomium)",
          "shortname": "5. Moz."
        },
        {
          "id": 6,
        ...
        {
          "id": 9,
          "name": "Pirmā Samuēla grāmata",
          "shortname": "1. Sam."
        },
        {
          "id": 10,
          "name": "Otrā Samuēla grāmata",
          "shortname": "2. Sam."
        },
        {
          "id": 11,
          "name": "Pirmā Ķēniņu grāmata",
          "shortname": "1. Ķēn."
        },
        {
          "id": 12,
          "name": "Otrā Ķēniņu grāmata",
          "shortname": "2. Ķēn."
        },
        {
          "id": 13,
          "name": "Pirmā Laiku grāmata",
          "shortname": "1. Lku."
        },
        {
          "id": 14,
          "name": "Otrā Laiku grāmata",
          "shortname": "2. Lku."
        },
        {
          "id": 15,
        ...
        {
          "id": 16,
          "name": "Nehemijas grāmata",
          "shortname": "Neh."
        },
        {
          "id": 17,
          "name": "Esteres grāmata",
          "shortname": "Est."
        },
        {
          "id": 18,
        ...
        {
          "id": 22,
          "name": "Salamana Augstā dziesma",
          "shortname": "A.dz."
        },
        {
          "id": 23,
          "name": "Jesajas grāmata",
          "shortname": "Jes."
        },
        {
          "id": 24,
          "name": "Jeremijas grāmata",
          "shortname": "Jer."
        },
        {
          "id": 25,
        ...
        {
          "id": 26,
          "name": "Ecēhiēla grāmata",
          "shortname": "Ec."
        },
        {
          "id": 27,
          "name": "Daniēla grāmata",
          "shortname": "Dan."
        },
        {
          "id": 28,
          "name": "Hozejas grāmata",
          "shortname": "Hoz."
        },
        {
          "id": 29,
        ...
        {
          "id": 35,
          "name": "Habakuka grāmata",
          "shortname": "Hab."
        },
        {
          "id": 36,
          "name": "Cefanjas grāmata",
          "shortname": "Cef."
        },
        {
          "id": 37,
        ...
        {
          "id": 38,
          "name": "Caharijas grāmata",
          "shortname": "Cah."
        },
        {
          "id": 39,
          "name": "Maleahija grāmata",
          "shortname": "Mal."
        },
        {
          "id": 40,
          "name": "Mateja evaņģēlijs",
          "shortname": "Mt."
        },
        {
          "id": 41,
          "name": "Marka evaņģēlijs",
          "shortname": "Mk."
        },
        {
          "id": 42,
          "name": "Lūkas evaņģēlijs",
          "shortname": "Lk."
        },
        {
          "id": 43,
          "name": "Jāņa evaņģēlijs",
          "shortname": "Jņ."
        },
        {
          "id": 44,
        ...
        {
          "id": 45,
          "name": "Pāvila vēstule romiešiem",
          "shortname": "Rom."
        },
        {
          "id": 46,
          "name": "Pāvila 1. vēstule korintiešiem",
          "shortname": "1. Kor."
        },
        {
          "id": 47,
          "name": "Pāvila 2. vēstule korintiešiem",
          "shortname": "2. Kor."
        },
        {
          "id": 48,
          "name": "Pāvila vēstule galatiešiem",
          "shortname": "Gal."
        },
        {
          "id": 49,
          "name": "Pāvila vēstule efeziešiem",
          "shortname": "Ef."
        },
        {
          "id": 50,
          "name": "Pāvila vēstule filipiešiem",
          "shortname": "Fil."
        },
        {
          "id": 51,
          "name": "Pāvila vēstule kolosiešiem",
          "shortname": "Kol."
        },
        {
          "id": 52,
          "name": "Pāvila 1. vēstule tesaloniķiešiem",
          "shortname": "1. Tes."
        },
        {
          "id": 53,
          "name": "Pāvila 2. vēstule tesaloniķiešiem",
          "shortname": "2. Tes."
        },
        {
          "id": 54,
          "name": "Pāvila 1. vēstule Timotejam",
          "shortname": "1. Tim."
        },
        {
          "id": 55,
          "name": "Pāvila 2. vēstule Timotejam",
          "shortname": "2. Tim."
        },
        {
          "id": 56,
          "name": "Pāvila vēstule Titam",
          "shortname": "Tit."
        },
        {
          "id": 57,
          "name": "Pāvila vēstule Filemonam",
          "shortname": "Filem."
        },
        {
          "id": 58,
          "name": "Vēstule ebrejiem",
          "shortname": "Ebr."
        },
        {
          "id": 59,
        ...
        {
          "id": 60,
          "name": "Pētera 1. vēstule",
          "shortname": "1. Pēt."
        },
        {
          "id": 61,
          "name": "Pētera 2. vēstule",
          "shortname": "2. Pēt."
        },
        {
          "id": 62,
