module.exports = {
    ...
    'Bible SuperSearch': 'Поиск по Библии',
    'Loading, please wait': 'Идет загрузка, пожалуйста, подождите',

    // Search Forms
    'Select Bible version(s)': 'Выберите версии Библии',
    'Search': 'Поиск',
    'Search the Bible': 'Искать в Библии',
    'Go': 'Открыть',
    'Bible Search': 'Поиск в Библии',
    'Bible': 'Библия',
    'Whole Words Only': 'Поиск с Использованием Только Точных Слов',
    'Whole words only': 'Поиск с использованием только точных слов',
    'Whole words': 'Поиск по точным словам',
    'Exact Case': 'Поиск чувствителен к регистру символов',
    'Parallel Bible #': 'Параллельная Библия #',
    'Select a Bible': 'Выберите Библию',
    'Add Bible': 'Добавить Библию',
    'Remove Bible': 'Удалить Библию',
    'Random Chapter': 'Открыть Случайную Главу',
    'Random Verse': 'Открыть Случайный Стих',
    'Passages': 'Библейские отрывки',
    'Passage': 'Библейский отрывок',
    'The book of': 'Книга',
    'Look for': 'Искать',
    'Look up': 'Найти',
    'in': 'в',
    ...
    'A Chapter': 'Глава',
    'Chapters': 'Главы',
    'Find verses containing': 'Найдите стихи, содержащие',
    'Restrict search to': 'Ограничить поиск до', 
    ...
    'Enter word(s), phrase(s) or expression(s)' : 'Введите слова, фразы или выражения',
    'Example': 'Пример',

    'Search for' : 'Условия поиска',
    'Match': 'Соответствует',
    'All Words': 'Все Слова',
    'Any Word': 'Любое Слово',
    'Exact Phrase': 'Точная Фраза',
    'Only One Word': 'Только Одно Слово',
    'Two or More Words': 'Два или Более Слов',
    'Words Within 5 Verses': 'Слова, Найденные в Диапазоне 5 Стихов',
    'Words Within Same Chapter': 'Слова, Найденные в Рамках Одной Главы',
    'Words Within Same Book': 'Слова, Найденные в Рамках Одной Книги',
    'Boolean Expression': 'Поиск с Использованием Логических Операторов (Boolean Expression)',
    'Regular Expression': 'Поиск с Использованием Синтаксиса Регулярных Выражений (Regular Expression)',
    'Select one ...' : 'Выберите одно ...',

    'Enter search keyword(s) or passage reference(s)': 'Чтобы начать поиск введите ключевые слова или ссылки отрывков Библии',
    'Tip: Entering both a passage and a search query will result in the limitation of the search to the specified passage(s).': 'Совет: При одновременном вводе отрывков и ключевых слов, поиск будет выполняться только в пределах указанных отрывков.',
    
    // Advanced Search
    'Boolean Search': 'Логический Поиск (Boolean Search)',
    'Passage Retrieval': 'Открыть отрывки из Библии',
    'Find words within': 'Найти ключевые слова в выбранной области',
    'Proximity Search': 'Поиск в зависимости от удаленности ключевых слов в тексте (Proximity Search)',
    'Power Search': 'Расширенный Поиск',

    // <b> ... </b> is HTML for bold text, please ensure that your translation maintains the bold
    '<b>All</b> of the words' : '<b>Все</b> слова',
    '<b>Any</b> of the words' : '<b>Любое</b> слово',
    '<b>Only one</b> of the words': '<b>Только одно</b> слово',
    '<b>None</b> of the words' : '<b>Ни одно</b> из слов',
    'The <b>exact phrase</b>': '<b>Точная фраза</b>',
    ...
    'Enable Strong\'s Numbers': 'Включить Отображение Текста с Дополнительными Пояснениями Происхождения Слов, Конкорданс (Strong\'s)',
    ...
    'Select None': 'Выбрать Ничего', // 5.0
    'Select': 'Выбрать', // 5.0
    'Unselect': 'Отменить Выбор', // 5.0
    
    // Copy format options
    'Copy Format': 'Формат Копирования', // 5.0
    'Word Processor': 'Форматированный Текст', // 5.0
    'Outline' : 'Структурированный Текст', // 5.0
    'Custom': 'Настроить', // 5.0

    'Single Verses': 'Если Показаны Отдельные Стихи Отрывков, Содержащие Ключевое Слово Поиска', // 5.0
    'Reference - Text': 'Ссылка - Текст', // 5.0
    'Text - Reference': 'Текст - Ссылка', // 5.0
    'Text Only': 'Только Текст', // 5.0
    'Separate Line': 'В Отдельной Строке', // 5.0

    'Multi-verse Passages': 'Если Открыт Отрывок, Который Содержит Несколько Стихов', // 5.0
    'Reference - Passage': 'Ссылка - Отрывок', // 5.0
    'Passage - Reference': 'Отрывок - Ссылка', // 5.0
    'Passage Only': 'Только Отрывок', // 5.0
    ...
    // Settings Dialog
    'Settings' : 'Дополнительные Настройки', // 5.0
    ...
    // Audio Bible
    'Listen': 'Слушать', // 6.2
    'Audio Bible may have been generated by using AI, and not an actual human voice.': 'Аудиоверсия Библии может быть создана с помощью искусственного интеллекта, а не с использованием реального человеческого голоса.', // 6.2
    'Audio not available for this passage.': 'Аудиоверсия этого отрывка недоступна.', // 6.2
  
    // Result and error messages
    
    // Your search produced (number of verses) results
    'Your search produced' : 'Ваш поиск дал',  
    // (total number of verses)
    'results' : 'результатов',
    
    // Showing results [1] to [30]
    'Showing Results': 'Отображаются результаты поиска от',
    'to' : 'до',
    
    // Your search produced no results in [name of Bible version]
    'Your search produced no results in': 'Ваш поиск не дал результатов по Библии:', 
    'However, verses from this Bible have been included for comparison.': 'Однако стихи из этой Библии также включены и показаны для сравнения.',
    
    // Operators such as [boolean operator] cannot be at the (beginning|end) of your search
    'Operators such as': 'Логический оператор (Boolean operator)',
    'cannot be at the beginning of your search.': 'не может находиться перед ключевым словом поиска',
    'cannot be at the end of your search.': 'не может находиться после ключевым словом поиска',
    'Please remove it, or use it\'s lower case equivalent.': 'Пожалуйста, удалите его или используйте эквивалент в нижнем регистре.',

    // Your search for [attempted keywords] is invalid...
    'Your search for': 'При выполнении поиска по ключевому слову',
    'is invalid, and appears to be a passage reference.': 'результаты не найдены, и ваше ключевое слово выглядит как ссылка на отрывок из Библии. Чтобы открыть отрывок из Библии, пожалуйста, используйте правильное поле ввода, предусмотренное для этой цели.',
    'is invalid.': 'результаты не найдены.',

    // Your search was limited to [number of] verses
    'Your search was limited to': 'Количество отображаемых результатов поиска ограничено. Отображены',
    'Please refine your search if necessary': 'При необходимости уточните ключевое слово и повторите поиск',

    'This Bible is in the Public Domain.': 'Эта Библия находится в общественном достоянии (Public Domain).',
    'This Bible is provided for research purposes only.': 'Эта Библия предоставлена ​​только для исследовательских целей.',
    'An unknown error has occurred.' : 'Произошла неизвестная ошибка.',
    'An error has occurred, please try again later.': 'Произошла ошибка, повторите попытку позже.',
    'Error' : 'Ошибка',
    'Success': 'Успешно',
    'Cache not found': 'Кэш-память не найдена',
    ...
    'Your parentheses are mismatched.': 'Ваши скобки были введены неправильно.',
    'Your parentheses are mismatched, or you have a proximity operator inside of parentheses.': 'Неправильно введены скобки или в скобках указан оператор поиска расстояния местоположения ключевых слов в тексте (Proximity Search).',
    'Proximity operators such as PROX and CHAP can only be used with boolean searches' : 'Операторы поиска расстояния местоположения ключевых слов (Proximity Search), такие как PROX и CHAP, можно использовать только при реализации логического поиска (Boolean Search).',
    'Note: PROX / CHAP operators cannot be enclosed within parentheses or brackets': 'Примечание: Операторы PROX и CHAP нельзя заключать в круглые или квадратные скобки',
    'Your access to this API has been revoked.  Please contact system administrator.': 'Ваш доступ к этому API был отключен. Пожалуйста, свяжитесь с системным администратором.',

    // Dialogs - general
    'Close': 'Закрыть', 

    // Bible SOS dialog
    'Bible SOS': 'Помощь при Поиске Ответов в Библии',
    'Emergency Help from the Bible': 'Эти Библейские отрывки послужат вам помощью и поддержкой',
    'Where to go When ...': 'Они пригодятся для духовного укрепления, если вы в жизни окажетесь в одной из этих ситуаций',
    'Afraid': 'В страхе',
    'Anxious': 'Когда вы тревожный',
    'Backsliding': 'Падение в грех',
    'Bereaved': 'В печали',
    'Bitter or Critical': 'Не судить других',
    'Conscious of Sin': 'Сознание греха',
    'Defeated': 'Испытывая поражение',
    'Depressed': 'Испытывая разочарование и депрессию', 
    'Disaster Threatens': 'В опасности',
    'Discouraged': 'Когда не хватает смелости',
    'Doubting': 'В сомнениях',
    'Facing a Crisis': 'В кризис',
    'Faith Fails': 'Когда не хватает веры',
    'Friends Fail': 'Когда друзья тебя подвели', 
    'Hopeless': 'В отчаянии',
    'Leaving Home': 'Находясь в далеком и незнакомом месте',
    'Lonely': 'В одиночестве',
    'Needing God\'s protection': 'Когда нужна помощь Бога',
    'Needing Guidance': 'Когда необходимо руководство Бога',
    'Needing Peace': 'В поисках внутреннего спокойствия',
    'Needing Rules for Living': 'В поисках основных принципов жизни', 
    'Overcome': 'Преодоление трудностей',
    'Prayerful': 'Когда нужно молиться Богу',
    'Protected': 'Когда нужна защита Бога',
    'Sick or in Pain': 'В болезни и боли',
    'Sorrowful': 'Когда грустно',
    'Tempted': 'В искушениях', 
    'Thankful': 'Когда необходимо быть благодарным',
    'Traveling': 'В путешествиях и поисках',
    'Trouble, In': 'Когда вы страдаете',
    'Troubled': 'Когда вы под давлением',
    'Weary': 'Когда вы устали',
    'Worried': 'В волнении и заботах',
    ...
    'Birth of Christ / Life of Christ': 'Рождение и Жизнь Иисуса Христа',
    'Imperfection in Churches and Believers': 'Несовершенство Церквей и Верующих',
    'Early human history, especially that of Israel': 'Ранняя История Человечества и Израиля',
    'The relationship between the Old Testament Law and the Church': 'Взаимосвязь между Законом Ветхого Завета Библии и Церковью Божией в Новом Завете',
    'History and Law': 'История Законов, которые были даны Богом',
    ...
    'Your download should begin shortly': 'Загрузка скоро начнется',
    'If not, please click on the below link': 'Если загрузка не начинается, пожалуйста, нажмите на ссылку ниже',
    'Manual Download': 'Ручная Загрузка',
    'Please select at least one Bible': 'Пожалуйста, выберите хотя бы одну Библию',
    'Please select a format': 'Пожалуйста, выберите формат',
    'Are you sure you want to exit?  This will end the current download.': 'Вы уверены, что хотите выйти? Это остановит текущую загрузку.',
    'Plain Text' : 'Простой Текст',
    'Machine-readable Plain Text' : 'Машиночитаемый Простой Текст',
    'Spreadsheet' : 'Электронная Таблица (Spreadsheet)',
    'Databases': 'Базы Данных',

    'PDF - Compact Text, Letter, Words of Christ in Red': 'Файл PDF – Компактный (Compact) текст, размер листа Letter, слова Иисуса Христа выделены красным цветом',
    'PDF - Compact Text, A4, Words of Christ in Red': 'Файл PDF – Компактный (Compact) текст, размер листа A4, слова Иисуса Христа выделены красным цветом',
    'PDF - Compact Text, Letter, Words of Christ Underlined': 'Файл PDF – Компактный (Compact) текст, размер листа Letter, слова Иисуса Христа подчеркнуты',
    'PDF - Compact Text, A4, Words of Christ Underlined': 'Файл PDF – Компактный (Compact) текст, размер листа A4, слова Иисуса Христа подчеркнуты',

    // Copy / Share / Link dialogs
    'Copy': 'Копировать',
    'Copy Link': 'Копировать Ссылку',
    'Copy with Text': 'Копировать с Текстом',
    ...
    'Advanced Searches using Boolean': 'Расширенный Поиск с использованием логических (Boolean) операторов',
    'Select' : 'Выбираете',
    'Operators': 'Операторы',
    'Operator': 'Оператор',
    'Aliases': 'Используемый Символ',
    'Description': 'Описание',
    'Match both': 'Поиск по обоим ключевым словам одновременно',
    'Match either': 'Поиск по тому или иному ключевому слову',
    'Match only one': 'Поиск отрывков, в которых встречается только первое или только второе ключевое слово',
    'Does not match': 'Поиск отрывков, в которых первое ключевое слово встречается только без второго указанного ключевого слова',
    'Matches words in the same chapter': 'Искать только тех отрывков, где встречается одно или оба ключевых слова, только если оба ключевых слова встречаются в одной и той же главе',
    'Matches words in the same book': 'Искать только тех отрывках, где встречаются одно или оба ключевых слова, только если оба ключевых слова встречаются в одной книге',
    'Matches words in the same book, and within N verses of each other': 'Искать только те отрывки, где встречаются одно или оба ключевых слова, только если оба ключевых слова встречаются в одной книге в диапазоне \'N\' последовательных стихов',
    'Matches words in the same chapter, and within N verses of each other': 'Искать только те отрывки, где встречаются одно или оба ключевых слова, только если оба ключевых слова встречаются в одной главе в диапазоне \'N\' последовательных стихов',
    'For details, please see the User\'s Manual': 'Дополнительную подробную информацию об использовании этого инструмента для поиска по Библии можно найти в Руководстве Пользователя (нажав ниже)',
    'Special Proximity Operators': 'Специальные операторы расстояния местоположения ключевого слов (Proximity Operators)',
    'Matches unlimited characters': 'Поиск соответствует неограниченному количеству доступных для поиска символов',
    'searched for': 'искали такое',
    ...
    // 5.7:
    'Include Link': 'Включить Ссылку',
    'Include Formatting': 'Включить Форматирование',
    'Resume Search': 'Возобновить Поиск',
