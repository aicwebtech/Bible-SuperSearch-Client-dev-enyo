...
module.exports = kind({
    ...
    renderPassageParallelBible: function(pd) {
        ...
        if(!this.multiBibles) {
            ...
            refContent += '<a href="' + bssUtils.escapeHtml(addLink) + '" title="' + bssUtils.escapeHtml(this.app.t('Add to List')) + '" class="bss_std_link">' + bssUtils.escapeHtml(this.app.t('Add to List')) + '</a> &nbsp; ';
        ...
        if(this.multiBibles) {        
            ...
            for(i in this.bibles) {
                ...
                bibleContent += '<a href="' + bssUtils.escapeHtml(addLink) + '" title="' + bssUtils.escapeHtml(this.app.t('Add to List')) + '" class="bss_std_link">' + bssUtils.escapeHtml(this.app.t('Add to List')) + '</a> &nbsp;';
