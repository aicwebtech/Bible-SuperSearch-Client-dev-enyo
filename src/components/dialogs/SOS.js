...
module.exports = kind({
    ...
    published: {
        list: [
            ...
            {label: 'Conscious of Sin', verses: 'Proverbs 28:13; 1 John 1:6-10; Romans 1:21-32'},
            ...
            {label: 'Needing Rules for Living', verses: 'Exodus 20:1-17; Romans 12', newColumn: true},
        ...
        list.forEach(function(item) {
            ...
            if(label) {
                this.$.ListContainer.$[colName].createComponent({
                    verses: item.verses,
                    owner: this,
                    classes: 'bss_item bss_sos_item', components: [
                        {classes: 'bss_label', content: label},
                ...
                this.$.ListContainer.$[colName].createComponent({
                    ...
                    owner: this,
                    classes: 'bss_item bss_sos_item', components: [
                        {classes: 'bss_verses_wide', components: [
                            {kind: Anchor, href: url, _title: versesTranslated, content: versesTranslated, ontap: 'handleVerseTap'}
                        ]},
                    ],
                });
